...
export async function POST(req: NextRequest) {
  try {
    ...
    if (insertError) {
      ...
      if (insertError.message?.includes("restricted") || insertError.message?.includes("quota") || insertError.message?.includes("violation") || insertError.message?.includes("limit") || insertError.message?.includes("Service for this project is restricted")) {
