-- Settings Module Database Tables Creation Script
...
INSERT INTO invoice_templates (name, type, template_data, is_active) VALUES
...
-- 8. Create policies for access control
CREATE POLICY "Enable all operations for company_settings" ON company_settings FOR ALL USING (true);
CREATE POLICY "Enable all operations for branding_settings" ON branding_settings FOR ALL USING (true);
CREATE POLICY "Enable all operations for document_settings" ON document_settings FOR ALL USING (true);
CREATE POLICY "Enable all operations for banking_details" ON banking_details FOR ALL USING (true);
CREATE POLICY "Enable all operations for invoice_templates" ON invoice_templates FOR ALL USING (true);
