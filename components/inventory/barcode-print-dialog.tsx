...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .name { font-size: 6pt; font-weight: bold; color: #000; text-align: center; max-width: 48mm; height: 5mm; overflow: hidden; line-height: 1.1; word-break: break-word; }
  .prices { display: flex; align-items: center; justify-content: center; gap: 2px; height: 3mm; line-height: 1; }
  .regular-price { font-size: 4pt; color: #666; text-decoration: line-through; }
  .sale-price { font-size: 6pt; font-weight: bold; color: #000; }
  .barcode { width: 42mm; height: 8mm; display: block; image-rendering: pixelated; image-rendering: crisp-edges; }
  .code { font-size: 5pt; font-weight: bold; color: #000; text-align: center; height: 2mm; line-height: 1; }
  .website { font-family: Arial, sans-serif; font-size: 4pt; color: #000; height: 2mm; line-height: 1; }
