...
interface PrintSettings {
  paperSize: "thermal-4x6" | "thermal-4x8" | "a0" | "a1" | "a2" | "a3" | "a4" | "a5" | "a6" | "a7" | "a8" | "b4" | "b5" | "b6" | "letter" | "legal" | "custom"
  columns: number
  marginTop: number
  marginLeft: number
  marginRight: number
...
export function SimpleBarcodePrinter({
  ...
  // Paper size presets - EXPANDED (15+ sizes)
  const PAPER_SIZES = {
    "thermal-4x6": { name: "Thermal 4×6 inch", width: 101.6, height: 152.4 },
    "thermal-4x8": { name: "Thermal 4×8 inch", width: 101.6, height: 203.2 },
    ...
    letter: { name: "Letter (8.5×11 inch)", width: 215.9, height: 279.4 },
    legal: { name: "Legal (8.5×14 inch)", width: 215.9, height: 355.6 },
